...
public class JsonWriter implements Closeable, Flushable
{
	 ...
	 * HTML and XML documents. This escapes the HTML characters {@code <},
	 * {@code >}, {@code &} and {@code =} before writing them to the stream.
	 * Without this setting, your XML/HTML encoder should replace these
	 * characters with the corresponding escape sequences.
	 */
