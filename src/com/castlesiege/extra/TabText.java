...
public class TabText
{
	 ...
	 * 
	 * @param chatHeight
	 *            lines you want for each page, no more than 10 recommended
	 ...
	 * 
	 * @param tabs
	 *            an integer list with desired tab column positions
	 */
	 ...
	 * 
	 * @param chars
	 *            a string with the chars to be added (careful with unicode or
	 *            ansi chars, do some tests before)
	 * @param charsWidth
	 *            horizontal space in pixels each char occupies
	 */
	 ...
	 * 
	 * @param page
	 *            desired page number (0 = all in one), considering
	 *            preconfigured page height
	 * @param monospace
	 *            true if fonts are fixed width (for server console) or false if
	 *            variable with (for chat area)
	 ...
	 * @param mono
	 *            true if lenght will be in chars (for console) or false if will
	 *            be in pixels (for chat area)
	 ...
	 * @param mono
	 *            true for result in chars or false for result in pixels
	 ...
	 * 
	 * @param keys
	 *            a list of column numbers criteria where 1 represents first
